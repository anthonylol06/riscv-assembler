...
int inst_to_binary(
    ...
    // Unconditional Jumps
        ...
        binary = 0x6f;
        binary += (reg_to_num(arg1, line_no) << 7);
        int temp = handle_label_or_imm(line_no, arg2, label_table, number_of_labels);
        int offset = temp - addr;
    ...
    // Load and Store Instructions
        ...
        //imm[4:0]
        binary += (reg_to_num(ret->reg, line_no) << 15);
        binary += ((MASK11_0(ret->imm) & 0x01f) << 7);
        //imm[11:5]
        binary += ((MASK11_0(ret->imm) & 0xfe0) << 25);
